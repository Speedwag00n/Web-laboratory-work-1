...
First laboratorian work of "Web Programming" subject
## Description
This branch contains realisation of first laboratorian work of "Web Programming" subject (Variant 211015).
## Task (on Russian)
...
* При работе с CSS должно быть продемонстрировано использование селекторов потомств, селекторов классов, селекторов псевдоклассов, селекторов идентификаторов а также такие свойства стилей CSS, как наследование и каскадирование.
